...
extension EnviromentEnergyScene{
    func setupWindMills(){
        ...
        flyingWindMillOne.position = CGPoint(x: 120, y: size.height - 80)
        staticWindMillOne.position = CGPoint(x: 120, y: size.height - 118)
        ...
        flyingWindMillTwo.position = CGPoint(x: 50, y: size.height - 90)
        flyingWindMillTwo.xScale = 0.75
        flyingWindMillTwo.yScale = 0.75
        staticWindMillTwo.position = CGPoint(x: 50, y: size.height - 118)
        ...
        flyingWindMillThree.position = CGPoint(x: 190, y: size.height - 90)
        flyingWindMillThree.xScale = 0.75
        flyingWindMillThree.yScale = 0.75
        staticWindMillThree.position = CGPoint(x: 190, y: size.height - 118)
    ...
    func setupTitleLabel(){
        ...
        let attributedText = NSMutableAttributedString.init(string: "Click on the renewable energy sources\nto charge apple's datacenter")
        attributedText.setAttributes([NSAttributedStringKey.paragraphStyle: paragraph, NSAttributedStringKey.font: UIFont.systemFont(ofSize: 20, weight: .light)], range: NSMakeRange(0, (titleLabel.text?.count)!))
