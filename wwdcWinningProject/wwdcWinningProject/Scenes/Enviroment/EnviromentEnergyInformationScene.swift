...
public class EnviromentEnergyInformationScene: SKScene{
    ...
    override public func didMove(to view: SKView) {
        ...
        run(.sequence([.wait(forDuration: 5.0), callFacilitiesInformation(), .wait(forDuration: 5.0), createNextButton()]))
    }
...
extension EnviromentEnergyInformationScene{
    ...
    func setupGlobalFacilitiesInformation(){
        ...
        facilitiesInformation.position = CGPoint(x: size.width * 0.4, y: size.height/2 - 50)
        ...
        batteryNode.position = CGPoint(x: facilitiesInformation.position.x - 100, y: facilitiesInformation.position.y)
